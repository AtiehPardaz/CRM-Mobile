...
public class TasksListAdapter extends BaseAdapter {
	...
	String[][] taskIDList = new String[24][30];
	int pos;
	...
	TextView Hour;
	public TasksListAdapter(Activity a, List<List<String[]>> tasksList ,int numberOfTasks, boolean[][] titleSet, String[][] taskIDs) {
		activity = a;
		data = tasksList;
