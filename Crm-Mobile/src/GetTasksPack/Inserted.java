...
private List<ProductsId> ProductsIds = new ArrayList<ProductsId>();
private List<ServicesId> ServicesIds = new ArrayList<ServicesId>();
...
* The ProductsIds
*/
public List<ProductsId> getProductsIds() {
return ProductsIds;
}
...
* The ProductsIds
*/
public void setProductsIds(List<ProductsId> ProductsIds) {
...
* The ServicesIds
*/
public List<ServicesId> getServicesIds() {
return ServicesIds;
}
...
* The ServicesIds
*/
public void setServicesIds(List<ServicesId> ServicesIds) {
