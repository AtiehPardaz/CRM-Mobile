...
public class CmListFromAtcivityToProduct extends BaseAdapter {
	Context context;
	...
	public CmListFromAtcivityToProduct(Activity a, String[] arrayid, String[] arraytitle,String[] arrayselected,
			Context c) {
